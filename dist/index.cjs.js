...
function useGrid(props) {
    ...
    var initItems = React.useRef([]); // initial sizes and positions of items
     ...
     */
    var loopInGrid = React.useCallback(function (forEach) {
     ...
     *
     */
    var clearGrid = React.useCallback(function () {
     ...
     */
    var getUpdatedCell = React.useCallback(function (cell, row, col, sizeX, sizeY) {
     ...
     */
    var paintCellOnFreeSpace = React.useCallback(function (cell) {
        loopInGrid(function (row, col) {
     ...
     */
    var getColumnsFitOnScreen = React.useCallback(function () {
    ...
    var _a = React.useState(getColumnsFitOnScreen()), currentNumberOfColumns = _a[0], setCurrentNumberOfColumns = _a[1];
    /**
     * Returns the total width of the grid in px.
     *
     * @return {number} The total width of the grid.
     */
    var getGridWidth = React.useCallback(function () {
     ...
     */
    var getMarginLeft = React.useCallback(function () {
     ...
     */
    var getGridHeight = React.useCallback(function () {
     ...
     * @return {void}
     */
    var createGrid = React.useCallback(function () {
        for (var rows = 0; rows < numberOfRows; rows++) {
            grid.current[rows] = [];
            for (var cols = 0; cols < currentNumberOfColumns; cols++) {
     ...
     * @return {void}
     */
    var registerGridItem = React.useCallback(function (index) {
     ...
     * @return {void}
     */
    var registerGridItems = React.useCallback(function () {
        initItems.current = [];
    ...
    createGrid();
    registerGridItems();
    var _b = React.useState(initItems.current), cells = _b[0], setCells = _b[1];
    var _c = React.useState(getMarginLeft()), marginLeft = _c[0], setMarginLeft = _c[1];
    var _d = React.useState(getGridHeight()), gridHeight = _d[0], setGridHeight = _d[1];
    var _e = React.useState(false), triggerReset = _e[0], setTriggerReset = _e[1];
    var _f = React.useState(-1), selectedCell = _f[0], setSelectedCell = _f[1];
    var _g = React.useState(getColumnsFitOnScreen() == 2), isGridSmall = _g[0], setIsGridSmall = _g[1];
